...
def setColor(pFOREGROUND, pBACKGROUND):
    ...
    return
#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
def setBackgroundColor(pBACKGROUND):    
    
    b = pBACKGROUND.upper()
    
    if  b == "BLACK": cengine.graphics.bgColorPair = 7
    elif  b == "BLUE": cengine.graphics.bgColorPair = 15
    elif  b == "CYAN": cengine.graphics.bgColorPair = 23
    elif  b == "GREEN": cengine.graphics.bgColorPair = 31
    elif  b == "MAGENTA": cengine.graphics.bgColorPair = 39
    elif  b == "RED": cengine.graphics.bgColorPair = 47
    elif  b == "WHITE": cengine.graphics.bgColorPair = 55
    elif  b == "YELLOW": cengine.graphics.bgColorPair = 63
