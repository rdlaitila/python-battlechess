...
def cengine_draw():
    ...
    if pause == False:
        ...
        if debug:
            ...
            cengine.graphics.printstr( "Canvas Origin to Window: (" + str(xOrigin) + "," + str(yOrigin) + ")", 0 + xTO, 3 + yTO)                
            cengine.graphics.printstr( "Canvas Draw Operation Translate: (" + str(xTranslate) + "," + str(yTranslate) + ")", 0 + xTO, 4 + yTO)
            cengine.graphics.line( "-", 0 + xTO, 5 + yTO, cengine.graphics.getWidth() + xTO, 5 + yTO )        
        #time.sleep(1)
...
def cengine_keypressed(keycode):
    ...
    #elif keycode == 260:
     #   cengine.canvas.xOrigin = cengine.canvas.xOrigin + 1
    #elif keycode == 261:
     #   cengine.canvas.xOrigin = cengine.canvas.xOrigin - 1
    #elif keycode == 259:
     #   cengine.canvas.yOrigin = cengine.canvas.yOrigin + 1
    #elif keycode == 258:
     #   cengine.canvas.yOrigin = cengine.canvas.yOrigin - 1    
    elif keycode == 258:
